...
// HTTP behaviour is covered in jolpiaf1_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "jolpiaf1://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("jolpiaf1", "about")
	if err != nil || got.String() != "jolpiaf1://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want jolpiaf1://page/about", got.String(), err)
	}
}
